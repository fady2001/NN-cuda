...
///**
//* @brief
//*  this a template function to be suitable for float and double numbers to apply cross entropy
//*
...
//
//template <class T>
//void cross_entropy_cpu(T *in, uint*targets,T *softmaxed,T*losses, int N, int C)
//{
...
//
//template <class T>
//void run_kernel1(T *in, uint*targets,T *softmaxed,T*losses, int N, int C, int block_size)
//{
//   int num_blocks = ceil_div(N, block_size);
//   cross_entropy_kernel << <num_blocks, block_size >> > (in, targets, softmaxed, losses, N, C);
//}
//
//int main()
//{
...
//
//#if TEST_PYTORTH
//   write_npy("cross-entropy-layer\\h_inp.npy", h_inp, 2, new unsigned long[2]{N, C});
//   write_npy<uint>("cross-entropy-layer\\h_targets.npy", h_targets, 1, new unsigned long[1]{N});
//#endif
//
//
//	// move to GPU
