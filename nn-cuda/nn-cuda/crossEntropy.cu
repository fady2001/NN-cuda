...
#if TEST_PYTORTH
    write_npy("cross-entropy-layer\\h_predictions.npy", h_predictions, 2, new unsigned long[2]{N, C});
    write_npy("cross-entropy-layer\\h_targets.npy", h_targets, 1, new unsigned long[1]{N});
#endif
