...
//    write_npy("all-model-cpu\\ln2w.npy", model.params.ln2w, 2, new unsigned long[2]{C, H1});
//    write_npy("all-model-cpu\\ln2b.npy", model.params.ln2b, 1, new unsigned long[1]{C});
//#endif
//
//    // run CPU
...
//    linear_layer_forward_cpu(model.activations.a1, model.params.ln2w, model.params.ln2b, model.activations.ln2, B, H1, C);
//    softmax_cpu(model.activations.ln2, model.activations.sm, B, C);
