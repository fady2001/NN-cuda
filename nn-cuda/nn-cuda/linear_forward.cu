...
//#if TEST_PYTORTH
//   write_npy("linear-layer\\X_c.npy", inp, 2, new size_t[2]{B, N});
//   write_npy("linear-layer\\W_C.npy", weight, 2, new size_t[2]{M, N});
//   write_npy("linear-layer\\bias_C.npy", bias, 1, new size_t[1]{M});
//#endif
//
//   // move to GPU
//   float *d_out;
...
//
//#if TEST_PYTORTH
//   write_npy("linear-layer\\out_C.npy", out, 2, new size_t[2]{B, M});
//#endif
//
