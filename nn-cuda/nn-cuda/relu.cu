...
//
//#if TEST_PYTORTH
//    write_npy("relu-layer\\X_relu.npy", inp, 2, new size_t[2]{B, N});
//    write_npy("relu-layer\\up_grad_relu.npy", grad_output, 2, new size_t[2]{B, N});
//#endif
//
//    // Move to GPU
...
//
//#if TEST_PYTORTH
//    write_npy("relu-layer\\out_relu.npy", out, 2, new size_t[2]{B, N});
//    write_npy("relu-layer\\down_grad_relu.npy", grad_input, 2, new size_t[2]{B, N});
//#endif
//
...
//
//        float elapsed_time1 = benchmark_kernel(repeat_times, run_relu_kernel, d_inp, d_out, B, N, sqrt_block_size);
