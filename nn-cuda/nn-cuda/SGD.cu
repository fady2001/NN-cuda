...
#if TEST_PYTORTH
write_npy("SGD-optimizer\\params_memory.npy", params_memory, 1, new size_t[1]{num_parameters});
write_npy("SGD-optimizer\\grads_memory.npy", grads_memory, 1, new size_t[1]{num_parameters});
#endif
...
#if TEST_PYTORTH
write_npy("SGD-optimizer\\updated_params_memory.npy", params_memory, 1, new size_t[1]{num_parameters});
#endif
